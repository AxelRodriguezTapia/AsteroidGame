...
public class AsteraX : MonoBehaviour
{
    ...
    public static float timeToRestartLevel;
    ...
    void Start()
    {
        ...
        playerJumps = 3;
        timeToRespawn = 0;
        timeToRestartLevel = 0;
        
        GameOverText.text = "";
        ScoreText.text = playerScore.ToString();
        JumpsText.text = playerJumps.ToString();
        FinalScoreText.text = "";
        isGameOver = false;
    }
    ...
    void Update()
    {
        ...
        if (isGameOver)
        {
            ...
            ScoreText.text = "";
            JumpsText.text = "";
            timeToRestartLevel += Time.deltaTime;
            if (timeToRestartLevel >= 5)
            {
    ...
    {
        playerJumps--;
        Debug.Log("Jumps left: "+playerJumps);
        if (playerJumps < 0)
        {
            //Pantalla de final.
            isGameOver = true;
    ...
    static public int getPlayerJumps()
    {
        return playerJumps;
    }
    ...
    static public void respawnPlayer()
    {
        ...
        {
            pos = ScreenBounds.RANDOM_ON_SCREEN_LOC;
        } while (pos.magnitude < MIN_ASTEROID_DIST_FROM_PLAYER_SHIP);
        Instantiate(AsteroidsSO.GetPlayerPrefab(), pos, Quaternion.identity);
    }
